...
const sourceIcons: Record<AssignmentSource, React.ReactNode> = {
    ...
    'google-classroom': <BookOpen className="w-4 h-4 text-primary-500" />,
    notes: <FileText className="w-4 h-4 text-amber-500" />,
    manual: <FileText className="w-4 h-4 text-surface-400" />,
};
